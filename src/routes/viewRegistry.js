...
//
// v1.198 (multi-user M2) — `cap` per view: de sleutel uit `public.capabilities`
// die deze view opent. Dashboard.jsx filtert hierop zodra `my_capabilities()`
// geladen is; tot die tijd valt hij terug op `adminOnly || isOwner` (de
// filtering van vóór M2), zodat een hapering nooit een lege navigatie geeft.
//
// `adminOnly` is BEWUST blijven staan naast `cap`. Het is de terugvalregel én
// het antwoord op de vraag "wat gebeurt er als de RPC niet laadt" — twee
// verschillende dingen die toevallig meestal hetzelfde zeggen. Voor de owner
// zijn ze identiek: zijn preset bevat alle 32 rechten.
//
// Views zonder `cap` (updates) zijn voor iedereen. `cap: 'organisatie.*'` is
// de wildcard voor het portaal: één van de organisatie-rechten volstaat.
export const VIEWS = [
  ...
  { id: 'hubspot',         label: 'Administratie', title: 'Administratie · Admin',    subtitle: '', fullWidth: true, cap: 'administratie' },
  { id: 'hubspot_future',  label: 'Toekomst',      title: 'Administratie · Toekomst', subtitle: '', fullWidth: true, cap: 'administratie' },
  { id: 'autodraft',          label: 'Postvak',     title: 'Postvak',              subtitle: '1:1 je Outlook-inbox met een Maestro-voorstel per mail (Postvak v2-design).', fullWidth: true, cap: 'postvak' },
  { id: 'autodraft_settings', label: 'Instellingen', title: 'Mailing · Instellingen', subtitle: 'Voorstellen, categorieën, logboek en geleerde regels — alle skill-configuratie van auto-draft op één plek met tabs.', cap: 'postvak' },
  { id: 'agenda',             label: 'Agenda',      title: 'Agenda',               subtitle: 'Outlook-agenda met week- en dag-view. Toggle \"Toon spelregels\" rendert reistijd-buffers, verkeer-windows en interne dagen als shadow-laag. Outlook blijft bron-van-waarheid.', fullWidth: true, cap: 'agenda' },
  { id: 'agenda_rules',       label: 'Spelregels',  title: 'Agenda · Spelregels',  subtitle: 'Beheer alle spelregels van je agenda — verkeer-windows, reistijd-buffers, interne dagen, locatieregels en meer. Wijzigingen werken direct door op de agenda-view.', fullWidth: true, cap: 'agenda' },
  { id: 'taken',         label: 'Taken',         title: 'Taken',         subtitle: '', fullWidth: true, cap: 'taken' },
  { id: 'long_running',  label: 'Long running tasks', title: 'Long running tasks', subtitle: 'Elke geplande taak met de vraag die er nu toe doet: waar draait hij — in de app of nog in een externe Claude-routine — en hoe lang doet hij erover.', cap: 'organisatie.health' },
  ...
  { id: 'pipeline',        label: 'Pipeline',         title: 'Pipeline & forecast',     subtitle: '', fullWidth: true, adminOnly: true, cap: 'pipeline' },
  { id: 'datakwaliteit',   label: 'Datakwaliteit',    title: 'Datakwaliteit & hygiëne', subtitle: '', fullWidth: true, adminOnly: true, cap: 'datakwaliteit' },
  ...
  { id: 'kennisbank_review', label: 'Review-queue',   title: 'Review-queue',     subtitle: '', fullWidth: true, status: 'soon', cap: 'kennisbank' },
  { id: 'zoeken',        label: 'Dashboard',     title: 'Dashboard',     subtitle: '', fullWidth: true, cap: 'home' },
  // Analyse = chat/vragenbak (v1.158 polish). Nav-item onder Dashboard; ook
  // bereikbaar via sidebar-zoekveld / topbalk-icoon / ⌘K.
  { id: 'vragenbak',     label: 'Analyse',       title: 'Analyse',       subtitle: '', fullWidth: true, cap: 'analyse' },
  ...
  { id: 'health',        label: 'Health & Issues', title: 'Health & Issues', subtitle: 'In één blik welke agents echte aandacht vragen. Run-success per 7 dagen, fouten en stille agents. Bron: agent_runs_health_7d view; auto-refresh per minuut.', adminOnly: true, cap: 'organisatie.health' },
  { id: 'security',      label: 'Security',        title: 'Security Monitor', subtitle: 'Open bevindingen van de dagelijkse security-scan. Kritieke issues bovenaan. Klik op een bevinding voor detail; markeer als opgelost of geaccepteerd risico.', adminOnly: true, cap: 'organisatie.security' },
  ...
  { id: 'settings',  label: 'Instellingen',    title: 'Instellingen',     subtitle: '', fullWidth: true, cap: 'instellingen.eigen' },
  ...
  { id: 'admin',     label: 'Organisatie',     title: 'Organisatie',      subtitle: '', fullWidth: true, adminOnly: true, cap: 'organisatie.*' },
