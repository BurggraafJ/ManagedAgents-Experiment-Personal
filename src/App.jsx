...
const VIEWS = [
  ...
  { id: 'klantverlies_v2', label: 'Klantverlies v2',  title: 'Klantverlies',     subtitle: '', fullWidth: true },
...
const NAV_GROUPS = [
  ...
  { kind: 'group', id: 'customer-success', label: 'Customer Success',  children: ['klantverlies', 'klantverlies_v2', 'kennisbank', 'sales'] },
...
export const VIEW_PATHS = {
  ...
  klantverlies_v2:    '/klantverlies-v2',
