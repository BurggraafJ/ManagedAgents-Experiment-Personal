...
import HubSpotPriorityView from './components/views/HubSpotPriorityView'
import HubSpotInboxView   from './components/views/HubSpotInboxView'
import HubSpotThreadView  from './components/views/HubSpotThreadView'
import HubSpotReaderView  from './components/views/HubSpotReaderView'
...
const VIEWS = [
  ...
  { id: 'hubspot',      label: 'Daily Admin',             title: 'Daily Admin',              subtitle: 'Huidige weergave \u2014 alle secties uitgeklapt onder elkaar. Volledig, maar scroll-heavy.' },
  { id: 'hubspot_dense',    label: 'Daily Admin \u00b7 Dense',    title: 'Daily Admin \u2014 Dense',     subtitle: 'Zelfde sectie-concept, maar compacte 1-regel-kaarten per voorstel. Expand op klik voor detail. Veel items tegelijk in beeld.' },
  { id: 'hubspot_priority', label: 'Daily Admin \u00b7 Priority', title: 'Daily Admin \u2014 Priority',  subtitle: 'Zelfde sectie-concept, maar urgentste items bovenaan groot (hero-cards), rest in compact-grid eronder. Visuele hi\u00ebrarchie stuurt je aandacht.' },
  { id: 'hubspot_inbox',    label: 'Daily Admin \u00b7 Inbox',    title: 'Daily Admin \u2014 Inbox',     subtitle: 'Lijst links, detail rechts, zoeken + filters bovenaan. Goed voor snelle bulk-review.' },
  { id: 'hubspot_thread',   label: 'Daily Admin \u00b7 Thread',   title: 'Daily Admin \u2014 Thread',    subtitle: 'Inbox-concept, maar rijen klappen in-place uit (zoals Gmail). Geen apart detail-paneel \u2014 zie context van naastliggende items.' },
  { id: 'hubspot_reader',   label: 'Daily Admin \u00b7 Reader',   title: 'Daily Admin \u2014 Reader',    subtitle: 'Focused-reader-mode: \u00e9\u00e9n voorstel tegelijk centraal, navigeer met pijltjes. Minimale lijst rechts, distractiearm.' },
...
const NAV_GROUPS = [
  ...
  { kind: 'group', id: 'hubspot', label: 'HubSpot', children: ['hubspot', 'hubspot_dense', 'hubspot_priority', 'hubspot_inbox', 'hubspot_thread', 'hubspot_reader', 'sales', 'salestodo'] },
  { kind: 'spacer' },
  ...
  return (
    <div className="shell">
      ...
      <main className="main">
        ...
        {view === 'hubspot_priority' && <HubSpotPriorityView data={data} />}
        {view === 'hubspot_inbox'    && <HubSpotInboxView data={data} />}
        {view === 'hubspot_thread'   && <HubSpotThreadView data={data} />}
        {view === 'hubspot_reader'   && <HubSpotReaderView data={data} />}
