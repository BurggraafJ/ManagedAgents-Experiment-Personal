    ...
    try {
      ...
      const [pRes, cRes] = await Promise.all([
        supabase
          ...
          .select('id, action_slug, payload, was_suggested, suggested_rank, classifier_confidence, classifier_reasoning, outcome, decided_at, executed_at, linked_entities, created_at')
          .eq('mail_id', mailId)
