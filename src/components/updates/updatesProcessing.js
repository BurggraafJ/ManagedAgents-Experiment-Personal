...
// dag-grouping en de transformatie van rauwe platform_updates-dagen naar het
// view-model dat UpdatesTimeline rendert. Geen JSX, geen React.
// Copy-opschoning (commit-message → leesbare tekst) leeft in updatesHumanize.

import { splitMessage } from './updatesHumanize'
...
const MODULE_PATTERNS = [
  ...
  { test: /^src\/components\/views\/organisatie\//, name: 'Organisatie', icon: 'shield' },
