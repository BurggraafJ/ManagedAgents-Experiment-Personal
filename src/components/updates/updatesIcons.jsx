// updatesIcons — lucide-stijl inline SVG-paths voor de module-iconen,
// tags en accenten van de Wat-is-nieuw-timeline. Gebruik <Icon name="..."/>.

const ICONS = {
  mail: <><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></>,
  calendar: <><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M3 10h18M8 2v4M16 2v4" /></>,
  'user-x': <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="m22 11-3 3-3-3M19 8v6" /></>,
  check: <><rect x="4" y="4" width="16" height="18" rx="2" /><path d="M9 2h6v4H9zM9 14l2 2 4-4" /></>,
  brain: <><circle cx="12" cy="12" r="9" /><path d="M9 9h6M9 13h6M9 17h3" /></>,
  ...
  sparkles: <><path d="m12 3 1.9 5.8L20 11l-6.1 2.2L12 19l-1.9-5.8L4 11l6.1-2.2z" /><path d="M19 3v4M21 5h-4M5 17v4M7 19H3" /></>,
  grid: <><rect x="3" y="3" width="7" height="9" rx="1.5" /><rect x="14" y="3" width="7" height="5" rx="1.5" /><rect x="14" y="12" width="7" height="9" rx="1.5" /><rect x="3" y="16" width="7" height="5" rx="1.5" /></>,
  scale: <path d="M16 16l3-8 3 8c-2 1.5-4 1.5-6 0M2 16l3-8 3 8c-2 1.5-4 1.5-6 0M7 21h10M12 3v18M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2" />,
  ...
  car: <><path d="M19 17h2v-5l-2-5H5L3 12v5h2M7 17h10" /><circle cx="7" cy="17" r="2" /><circle cx="17" cy="17" r="2" /></>,
