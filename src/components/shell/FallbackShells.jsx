// Fallback-shells (skeleton + error), verhuisd uit App.jsx bij de split van
// v1.128. Momenteel nergens gemount; bewaard als bouwsteen (geen functie
// verwijderen zonder groen licht — CLAUDE.md).
