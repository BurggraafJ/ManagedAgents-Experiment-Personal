...
const FUNCTIONS = [
  ...
  // --- AI / processing ---
  { slug: 'chunker',                  agent: 'chunker',                  category: 'AI',      label: 'Chunker',              desc: 'Chunkt + embedt 9 source-types naar chunks-tabel (text-embedding-3-large 3072d halfvec + GPT-5-nano contextual prefix). Cron */5.' },
  ...
  { slug: 'rag-search',               agent: null,                       category: 'AI',      label: 'RAG search',           desc: 'On-demand hybrid retrieval (vector + BM25 + RRF + recency) via match_chunks RPC voor het Search-tabblad', noTracking: true, trackingNote: 'On-demand call vanuit dashboard, geen run-logging' },
