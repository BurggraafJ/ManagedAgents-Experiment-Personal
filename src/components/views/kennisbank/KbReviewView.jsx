  ...
  return (
    <div className="theme-maestro knb-maestro">
      <div className="knb-inner">
        ...
        <div className="knb-head" style={{ marginBottom: 16 }}>
          <div>
            <div className="knb-head__eyebrow"><Lc d={I.check} />Voorstellen ter goedkeuring</div>
            <h1>Review-queue</h1>
            <p className="knb-head__sub">Kies links een voorstel; rechts lees je het artikel + de onderbouwing en keur je goed, pas je aan of wijs je af.</p>
          </div>
