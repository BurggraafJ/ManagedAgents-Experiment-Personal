...
import { TC_LEVELS, TC_MAX_LEVEL } from '../../../hooks/useTaalcheck'

/* Pv2Composer — het schrijfvlak van variant 2 (design: .comp-body, .refine)
 * plus de weergave van de taalcheck-met-track-changes. Gedeeld door het
 * concept-dock en de nieuwe-mail-sheet.
 *
 ...
 *
 * De hook zelf (`useTaalcheck`) staat sinds v1.203 in `src/hooks/` — mobiel
 * gebruikt hem ook, en die kan deze desktop-componenten niet meenemen. */
