...
const FUNCTIONS = [
  ...
  { slug: 'chunker',                   agent: 'chunker',                  category: 'AI',      label: 'Chunker',               desc: 'Chunkt + embedt 9 source-types naar chunks-tabel (text-embedding-3-large 3072d halfvec + GPT-5-nano contextual prefix)',
    consumedBy: ['rag-search', 'autodraft-rag-prefill', 'auto-draft'] },
  { slug: 'jellemind-embed',           agent: 'jellemind-embed',          category: 'AI',      label: 'JelleMind embed',       desc: 'Embeddings voor accepted lessons (parallel pipeline naast chunks)',
    consumedBy: ['jellemind'] },
