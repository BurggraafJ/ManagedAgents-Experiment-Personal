...
/**
 * SettingsV2Skeleton — loading-state voor SettingsV2View.
 *
 * Spiegelt SettingsV2Layout geometry (240px nav + content) zodat overgang
...
export default function SettingsV2Skeleton() {
  return (
    <Skeleton.Group label="Instellingen v2 wordt geladen">
