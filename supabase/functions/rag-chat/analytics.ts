...
//   nu de officiële lijstprijs (0,20/1,20) in plaats van een schatting.
...
3. "agentic" — data-gedreven vragen die MEERDERE stappen, bronnen of een redenering vereisen. Kies agentic bij:
   - combineren van bronnen: agenda/afspraken + HubSpot-notities + mail (activiteiten als trainingen, demo's, meetings);
   - vergelijken of verklaren over de tijd: "waarom"-analyses op churn/deals, periodes naast elkaar leggen, "geldt dat nu nog", trends, "vertel me alles over X en of dat nog speelt";
   - lijst/telling die eerst data ophalen en daarna per item doorvragen vereist.
   Voorbeelden: "welke trainingen zijn vorige maand gegeven bij welke klanten", "vertel me alles over de churnredenen van april en of die deze maand ook nog gelden", "vergelijk de pilots van dit kwartaal met vorig kwartaal", "welke demo's had ik in mei en wat vond men ervan". GEEN agentic voor puur mail-gedrag met één criterium (=sweep) of één enkel gestructureerd veld (=structured).
