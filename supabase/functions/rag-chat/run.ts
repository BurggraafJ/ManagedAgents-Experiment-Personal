...
async function finishRun(ctx: Ctx, res: Awaited<ReturnType<typeof composeAnswer>>): Promise<CompatResult> {
  ...
  const logMeta = { ...(c.baseLog.meta as Record<string, unknown>), answer_empty: answerEmpty, usage: cost.by_vendor, envelope_version: 1, hops: ctx.hop, agentic_model: ctx.dbg.agentic_model ?? null, budget_exhausted_by: ctx.dbg.agentic_budget_exhausted_by ?? null };
