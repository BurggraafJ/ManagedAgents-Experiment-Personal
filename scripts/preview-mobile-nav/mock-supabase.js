// Stub voor het navigatie-harnas (v1.204). De shots gaan over de tabbar en de
// Meer-drawer, niet over cijfers — de fixture is daarom dezelfde peiling als
// scripts/preview-home/mock-supabase.js, zodat de Home-kaarten erachter
// hetzelfde beeld geven als in de D1-shots en niet leeg blijven.
...
const D1_META = { peildatum: PEILDATUM, minuten_oud: 11, mirror_verouderd: false, deals_zichtbaar: 108 }
const AANVOER_KOP = {
...
const D10_META = { peildatum: PEILDATUM, minuten_oud: 11, mirror_verouderd: false, deals_zichtbaar: 1138, proeven: 17 }
const D10_KOP = [
